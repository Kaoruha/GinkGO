...
const columns = [
  ...
  { title: '收益率', dataIndex: 'annual_return', key: 'annual_return', width: 100, sortable: true, num: true },
  { title: '夏普', dataIndex: 'sharpe_ratio', key: 'sharpe_ratio', width: 80, sortable: true, num: true },
  { title: '最大回撤', dataIndex: 'max_drawdown', key: 'max_drawdown', width: 100, sortable: true, num: true },
  { title: '胜率', dataIndex: 'win_rate', key: 'win_rate', width: 80, sortable: true, num: true },
