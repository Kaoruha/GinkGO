...
.config-title {
  ...
  padding-bottom: 6px; border-bottom: 1px solid hsl(var(--border));
}
.config-item {
  display: flex; align-items: center; gap: 8px;
...
.config-item input[type="checkbox"] {
  accent-color: hsl(var(--primary)); width: 14px; height: 14px; cursor: pointer;
}
...
.event-time {
  flex-shrink: 0; font-size: 12px; color: hsl(var(--muted-foreground));
