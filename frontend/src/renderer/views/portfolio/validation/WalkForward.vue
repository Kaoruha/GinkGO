<template>
  <PageLayout>
    ...
    <template #description>
      时间序列交叉验证，评估策略样本外表现。退化程度大说明过拟合风险高。
    </template>
      ...
      <div class="card-body">
        <div class="form-row">
          ...
          <div class="form-group">
            ...
            <input
              v-model.number="config.trainRatio"
              type="range"
              min="0.5"
              max="0.9"
              step="0.1"
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div v-if="result">
          ...
          <div
            v-if="result.folds && result.folds.length > 0"
            class="table-wrapper"
          >
            <table class="data-table">
              ...
              <tr
                v-for="(record, i) in result.folds"
                :key="`fold-${i}`"
              >
                <td class="num">
                  {{ record.fold }}
