...
class TestMappingConstruction:
    ...
    @pytest.mark.unit
    def test_mapping_crud_has_required_methods(self, mapping_crud):
        ...
        for method_name in required_methods:
            assert hasattr(mapping_crud, method_name), f"缺少方法: {method_name}"
            assert callable(getattr(mapping_crud, method_name)), f"不可调用: {method_name}"
