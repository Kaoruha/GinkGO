...
class TestSignalTrackerCRUDConstruction:
    ...
    @pytest.mark.unit
    def test_signal_tracker_crud_has_required_methods(self, signal_tracker_crud):
        ...
        for method_name in required_methods:
            assert hasattr(signal_tracker_crud, method_name), f"缺少方法: {method_name}"
            assert callable(getattr(signal_tracker_crud, method_name)), f"不可调用: {method_name}"
