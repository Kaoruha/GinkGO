...
#3897: 验证 get_by_user_id 使用 list.first() 而非 results[0]
"""
...
class TestGetByUserIdReturnsFirst:
    """#3897: get_by_user_id 应使用 list.first() 语义"""
    ...
    def test_returns_first_match(self, crud_instance):
        ...
        crud_instance.find = MagicMock(return_value=[mock_model])
    ...
    def test_returns_first_of_multiple(self, crud_instance):
        ...
        crud_instance.find = MagicMock(return_value=[first, second])
