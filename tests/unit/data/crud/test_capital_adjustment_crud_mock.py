...
class TestCapitalAdjustmentCRUDConstruction:
    ...
    @pytest.mark.unit
    def test_capital_adjustment_crud_has_required_methods(self, capital_adjustment_crud):
        ...
        for method_name in required_methods:
            assert hasattr(capital_adjustment_crud, method_name), f"缺少方法: {method_name}"
            assert callable(getattr(capital_adjustment_crud, method_name)), f"不可调用: {method_name}"
