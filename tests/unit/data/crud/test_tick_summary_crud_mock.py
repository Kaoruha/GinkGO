...
class TestTickSummaryCRUDConstruction:
    ...
    @pytest.mark.unit
    def test_tick_summary_crud_has_required_methods(self, tick_summary_crud):
        ...
        for method_name in required_methods:
            assert hasattr(tick_summary_crud, method_name), f"缺少方法: {method_name}"
            assert callable(getattr(tick_summary_crud, method_name)), f"不可调用: {method_name}"
