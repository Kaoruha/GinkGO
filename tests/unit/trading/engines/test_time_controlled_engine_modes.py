...
class TestLiveModeManager:
    ...
    def test_live_manager_initialization(self):
        ...
        assert hasattr(engine, 'handle_event'), "实盘引擎应有handle_event方法"
...
class TestExecutionModeSwitching:
    ...
    def test_cross_mode_compatibility(self):
        ...
        engines = {
            ...
            'simulation': TimeControlledEventEngine(mode=EXECUTION_MODE.PAPER),
        ...
        for mode_name, engine in engines.items():
            ...
            assert hasattr(engine, 'handle_event'), f"{mode_name}引擎应有handle_event方法"
...
class TestTimeProviderIntegration:
    ...
    def test_time_provider_switching(self):
        ...
        modes_and_providers = [
            ...
            (EXECUTION_MODE.PAPER, SystemTimeProvider, TIME_MODE.SYSTEM),
