...
class TestBaseSelectorConstruction:
    ...
    def test_backtest_base_inheritance(self):
        ...
        assert callable(getattr(selector, 'bind_engine', None))
        assert callable(getattr(selector, 'set_name', None))
...
class TestSelectorExtensibility:
    ...
    def test_selector_polymorphism(self):
        ...
        for selector in selectors:
            ...
            assert callable(getattr(selector, 'pick', None))
        ...
        for selector in selectors:
            ...
            # 验证都可以调用继承的方法
            assert callable(getattr(selector, 'bind_data_feeder', None))
