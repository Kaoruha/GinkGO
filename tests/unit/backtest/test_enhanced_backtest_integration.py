...
class TestEnhancedBacktestIntegration:
    ...
    def test_unified_engine_mode_selection(self, mock_get_bars):
        ...
        assert callable(getattr(unified_engine, 'add_portfolio', None))
        assert callable(getattr(unified_engine, 'add_strategy', None))
        assert callable(getattr(unified_engine, 'start', None))
        assert callable(getattr(unified_engine, 'stop', None))
