...
class EnumConversionTest(unittest.TestCase):
    ...
    def test_enum_from_int_conversion(self):
        ...
        self.assertEqual(DIRECTION_TYPES.from_int(2), DIRECTION_TYPES.SHORT)
        self.assertEqual(DIRECTION_TYPES.from_int(-1), DIRECTION_TYPES.VOID)
    ...
    def test_enum_to_int_conversion(self):
        ...
        self.assertEqual(DIRECTION_TYPES.SHORT.to_int(), 2)
        self.assertEqual(DIRECTION_TYPES.VOID.to_int(), -1)
    ...
    def test_enum_validate_input(self):
        ...
        self.assertEqual(DIRECTION_TYPES.validate_input(DIRECTION_TYPES.SHORT), 2)
