# Upstream: ginkgo.trading.optimization.bayesian_optimizer
# Downstream: pytest
# Role: BayesianOptimizer 测试

"""
BayesianOptimizer 测试
...
class TestBayesianOptimizer:
    ...
    def test_get_importance(self, sample_param_ranges, mock_backtest_function):
        """测试获取参数重要性"""
        from ginkgo.trading.optimization.bayesian_optimizer import BayesianOptimizer
