...
#                 "limit_price": round(random.uniform(0, 100), 3),
#                 "frozen": random.randint(0, 1000),
#                 "transaction_price": round(random.uniform(0, 100), 3),
#                 "remain": round(random.uniform(0, 100), 3),
#                 "fee": round(random.uniform(0, 100), 3),
