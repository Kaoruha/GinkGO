...
class OperationPortfolioHandlerMappingTest(unittest.TestCase):
    ...
    def test_OperationPortfolioHandlerMapping_delete_by_portfolio(self) -> None:
        # TODO
        pass

    def test_OperationPortfolioHandlerMapping_softdelete_by_portfolio(self) -> None:
        # TODO
        pass
    ...
    def test_OperationPortfolioHandlerMapping_update(self) -> None:
        for i in self.params:
            ...
            df = get_portfolio_handler_mapping(res.uuid)
    ...
    def test_OperationPortfolioHandlerMapping_get(self) -> None:
        for i in self.params:
            size0 = get_table_size(self.model)
            res = add_portfolio_handler_mapping(**i)
            size1 = get_table_size(self.model)
            self.assertEqual(1, size1 - size0)
            df = get_portfolio_handler_mapping(id=res.uuid)
