...
#             df = get_portfolio_by_id(res.uuid)
...
#     def test_OperationPortfolio_get_by_id(self) -> None:
#         for i in self.params:
#             size0 = get_table_size(self.model)
#             res = add_portfolio(**i)
#             size1 = get_table_size(self.model)
...
#             params_copy["is_live"] = new_is_live
#             add_portfolio(**params_copy)
#         df = get_portfolios(is_live=new_is_live)
