...
class ModelAdjustfactorTest(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.params = [
            {
                "code": uuid.uuid4().hex,
                "adjustfactor": Decimal(str(round(random.uniform(0, 100), 2))),
                "foreadjustfactor": Decimal(str(round(random.uniform(0, 100), 2))),
                "backadjustfactor": Decimal(str(round(random.uniform(0, 100), 2))),
