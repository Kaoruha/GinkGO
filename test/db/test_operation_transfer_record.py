...
# def test_OperationTransferRecord_get_by_portfolio_with_date_range(self) -> None:
#     # Date filter
#     create_table(MTransferRecord)
#     size0 = get_table_size(MTransferRecord)
#     portfolio_id = uuid.uuid4().hex[:10]
...
# def test_OperationTransferRecord_get_by_portfolio_with_pagination(self) -> None:
#     create_table(MTransferRecord)
#     portfolio_id = uuid.uuid4().hex[:10]
#     l = []
#     for i in range(50):
