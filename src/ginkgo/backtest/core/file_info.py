...
class FileInfo(Base):
    ...
    def _(
        ...
        **kwargs
        ...
        self._desc = desc
        self._meta = meta
        self._create_at = datetime_normalize(create_at) if create_at else datetime.datetime.now()
        self._update_at = datetime_normalize(update_at) if update_at else datetime.datetime.now()
    ...
    def _(self, df: pd.Series) -> None:
        ...
        self._create_at = datetime_normalize(df.get("create_at", datetime.datetime.now()))
        self._update_at = datetime_normalize(df.get("update_at", datetime.datetime.now()))
