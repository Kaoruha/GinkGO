...
if TYPE_CHECKING:
    ...
    from ginkgo.backtest.trading.matchmakings import MatchMakingBase
...
class LiveEngine(EventEngine):
    ...
    def run_control_listener(self, flag) -> None:
        ...
        engine_crud.delete(filters={"engine_id": self.backtest_id})
    ...
    def process_control_command(self, command: dict) -> None:
        ...
        if command["command"].upper() == "PAUSE":
            ...
            engine_crud = container.cruds.engine()
            engine_crud.update(filters={"engine_id": self.engine_id}, status="running")
    ...
    def start(self) -> Thread:
        ...
        pid = os.getpid()
        engine_crud = container.cruds.engine()
        engine_crud.create(engine_id=self.engine_id, is_live=True)
    ...
    def pause(self) -> None:
        ...
        self._active = False
        engine_crud = container.cruds.engine()
        engine_crud.update(filters={"engine_id": self.engine_id}, status="pause")
    ...
    def stop(self) -> None:
        ...
        engine_crud = container.cruds.engine()
        engine_crud.update(filters={"engine_id": self.engine_id}, status="stop")
    ...
    def restart(self) -> None:
        ...
        engine_crud = container.cruds.engine()
        engine_crud.update(filters={"engine_id": self.engine_id}, status="restart")
