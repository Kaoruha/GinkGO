...
from ginkgo.backtest.computation.technical.base_indicator import BaseIndicator
...
class CandleWithIndexPlot(BasePlot):
    ...
    def add_index(self, index, type: str = "line") -> None:
        if not isinstance(index, BaseIndicator):
            GLOG.ERROR("Plot.add_index only support BaseIndicator.")
            return
