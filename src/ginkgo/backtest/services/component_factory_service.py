...
class ComponentFactoryService:
    ...
    def _initialize_base_class_mapping(self):
        ...
        try:
            from ginkgo.backtest.strategy.strategies import StrategyBase as BaseStrategy
            from ginkgo.backtest.analysis.analyzers import BaseAnalyzer
            from ginkgo.backtest.strategy.selectors import BaseSelector
            from ginkgo.backtest.strategy.sizers import BaseSizer
            from ginkgo.backtest.strategy.risk_managements import BaseRiskManagement as BaseRisk
