...
class LiveCore:
    ...
    def stop(self):
        ...
        print("[Step 4] Stopping DataFeeder...")
        ...
        # 4. 停止 Scheduler（停止调度）
        print("[Step 5] Stopping Scheduler...")
        ...
        # 5. 等待所有线程完成清理
        print(f"[Step 6] Waiting for {len(self.threads)} threads to finish...")
        finished_count = 0
        timeout_count = 0
