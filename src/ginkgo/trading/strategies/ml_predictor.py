...
class StrategyMLPredictor(StrategyMLBase):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if not hasattr(self, '_model') or self._model is None:
            ...
            self._risk_managements = risk_managements
    ...
    def generate_signals_from_prediction(self, portfolio_info, code: str, 
        ...
        try:
            ...
            if self._risk_managements:
                risk_signals = self._check_risk_managements(portfolio_info, code)
                if risk_signals:
    ...
    def get_position_info(self) -> Dict[str, Dict]:
        ...
        for code in self._entry_prices:
            position_info[code] = {
                ...
                'duration': (__import__('ginkgo.trading.time.clock', fromlist=['now']).now() - self._entry_times.get(code, __import__('ginkgo.trading.time.clock', fromlist=['now']).now())).days
            }
    ...
    def get_strategy_summary(self) -> Dict[str, any]:
        ...
        base_summary.update({
            ...
            'risk_managements_enabled': self._risk_managements,
