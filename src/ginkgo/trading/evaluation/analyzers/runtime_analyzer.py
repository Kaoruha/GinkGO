# Upstream: 回测引擎, 评估流水线RuntimeInspectionStage
# Downstream: core.evaluation_result (SignalTrace, SignalTraceReport), events.EventBase, GLOG
# Role: 运行时信号追踪分析器，通过SignalTracer上下文管理器捕获cal()调用，提供BarDataAdapter/TickDataAdapter事件适配
