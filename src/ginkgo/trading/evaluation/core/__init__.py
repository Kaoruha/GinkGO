# Upstream: evaluation顶层包, evaluators, rules, reporters
# Downstream: core.enums, core.evaluation_result
# Role: 评估核心子包入口，导出ComponentType/EvaluationLevel/EvaluationSeverity枚举和EvaluationResult/EvaluationIssue结果实体
