# Upstream: BaseCRUD(所有CRUD子类), 数据服务层
# Downstream: ginkgo.enums枚举类型, datetime, Decimal
# Role: 配置化数据验证框架，提供字段约束校验(类型/范围/枚举/正则)、类型转换和ValidationError统一异常
...
try:
    from ginkgo.enums import (
        ...
        EXECUTION_MODE, EXECUTION_STATUS, TRACKINGSTATUS_TYPES,
    ...
    EXECUTION_MODE = EXECUTION_STATUS = TRACKINGSTATUS_TYPES = None
...
ENUM_MAP = {
    ...
    'TRACKINGSTATUS_TYPES': TRACKINGSTATUS_TYPES,
