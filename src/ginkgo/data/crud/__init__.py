...
_LAZY_IMPORTS = {
    ...
    "BacktestLogCRUD": ("ginkgo.data.crud.log_crud", "BacktestLogCRUD"),
    "ComponentLogCRUD": ("ginkgo.data.crud.log_crud", "ComponentLogCRUD"),
    "PerformanceLogCRUD": ("ginkgo.data.crud.log_crud", "PerformanceLogCRUD"),
