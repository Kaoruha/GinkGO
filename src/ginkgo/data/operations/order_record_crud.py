...
def add_order_records(order_records: List[Union[Order, MOrder]], *args, **kwargs):
    l = []
...
def delete_order_record_by_id(id: str, connection: Optional[GinkgoClickhouse] = None, *args, **kwargs) -> int:
...
def softdelete_order_record_by_id(id: str, connection: Optional[GinkgoClickhouse] = None, *args, **kwargs) -> int:
    delete_order_record_by_id(id, connection, *args, **kwargs)


def delete_order_record_by_portfolio_id_and_date_range(
    portfolio_id: str,
...
def softdelete_order_record_by_portfolio_id_and_date_range(
    portfolio_id: str,
    start_date: Optional[any] = None,
    end_date: Optional[any] = None,
    connection: Optional[GinkgoClickhouse] = None,
    ...
    **kwargs,
    ...
    delete_order_record_by_portfolio_id_and_date_range(portfolio_id, start_date, end_date, connection, *args, **kwargs)
