...
# Role: MOrder订单记录MySQL模型定义订单数据结构和业务字段支持交易追踪
...
class MOrder(MMysqlBase, MBacktestRecordBase):
    ...
    def __init__(self,
                 ...
                 volume=None, limit_price=None, frozen_money=None, frozen_volume=None, transaction_price=None,
    ...
    def _(self, df: pd.Series, *args, **kwargs) -> None:
        ...
        self.frozen_money = to_decimal(df["frozen_money"]) if "frozen_money" in df else to_decimal(0)
