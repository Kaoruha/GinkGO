...
from ...libs import base_repr, datetime_normalize, to_decimal


class MSignalTracker(MMysqlBase):
    """
    信号追踪模型
    ...
    engine_id: Mapped[str] = mapped_column(String(32), default="", comment="引擎ID")
    ...
    def is_executed(self) -> bool:
        """判断是否已执行"""
        return self.tracking_status == TRACKING_STATUS.EXECUTED

    def is_pending(self) -> bool:
        """判断是否等待确认"""
        return self.tracking_status == TRACKING_STATUS.NOTIFIED

    def is_timeout(self) -> bool:
        """判断是否超时"""
        return self.tracking_status == TRACKING_STATUS.TIMEOUT
