...
class ServiceResult:
    ...
    def __init__(self, success: bool = False, error: str = None):
...
class DataService(BaseService):
    ...
    def _save_to_database(self, data: Union[Any, List[Any]], 
                         batch: bool = True) -> ServiceResult:
        """
...
class ManagementService(BaseService):
    ...
    def _check_entity_exists(self, identifier: str, 
                           field: str = "uuid") -> bool:
        """
