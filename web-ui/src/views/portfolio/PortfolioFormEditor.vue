  ...
  <div class="portfolio-form-editor" :class="{ 'modal-mode': isModalMode }">
    <div class="page-header">
      <div class="header-left">
        <a-button v-if="!isModalMode" @click="goBack" type="text">
          <LeftOutlined />
          返回
        </a-button>
      ...
      <div class="header-actions">
        <a-button @click="goBack">{{ isModalMode ? '取消' : '取消' }}</a-button>
                ...
                <div v-if="selector.parameters && selector.parameters.length > 0" class="item-params">
                  ...
                  >
                    ...
                    <a-switch
                      ...
                      v-model:checked="selector.config[param.name]"
                      size="small"
                    />
                    <!-- 下拉选择类型 -->
                    <a-select
              ...
              <div class="config-item">
                ...
                <div v-if="formData.sizer.parameters && formData.sizer.parameters.length > 0" class="item-params">
                  ...
                  >
                    ...
                    <a-switch
                      v-else-if="param.type === 'boolean'"
                      v-model:checked="formData.sizer.config[param.name]"
                      size="small"
                    />
                    <a-select
                      v-else-if="param.type === 'select'"
              ...
              >
                ...
                <div v-if="strategy.parameters && strategy.parameters.length > 0" class="item-params">
                  ...
                  >
                    ...
                    <a-switch
                      v-else-if="param.type === 'boolean'"
                      v-model:checked="strategy.config[param.name]"
                      size="small"
                    />
                    <a-select
                      v-else-if="param.type === 'select'"
              ...
              >
                ...
                <div v-if="risk.parameters && risk.parameters.length > 0" class="item-params">
                  ...
                  >
                    ...
                    <a-switch
                      v-else-if="param.type === 'boolean'"
                      v-model:checked="risk.config[param.name]"
                      size="small"
                    />
                    <a-select
                      v-else-if="param.type === 'select'"
              ...
              >
                ...
                <div v-if="analyzer.parameters && analyzer.parameters.length > 0" class="item-params">
                  ...
                  >
                    ...
                    <a-switch
                      v-else-if="param.type === 'boolean'"
                      v-model:checked="analyzer.config[param.name]"
                      size="small"
                    />
                    <a-select
                      v-else-if="param.type === 'select'"
...
const savePortfolio = async () => {
  ...
  if (result) {
    ...
    if (!isEditMode.value && result.uuid) {
